...
* GTF file for human genome: Go back to the Ensembl site above and look at the upper right pane, "Genome annotation". Click on the link to download a gtf file, and download Homo_sapiens.GRCh38.115.gtf.gz
